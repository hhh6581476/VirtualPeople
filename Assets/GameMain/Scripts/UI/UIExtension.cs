...
namespace StarForce
{
    public static class UIExtension
    {
        ...
        public static int? OpenUIForm(this UIComponent uiComponent, UIFormId uiFormId, object userData = null,UIGroupId uiGroupId = UIGroupId.Default,bool pauseCoveredUIForm=true)
        {
            return uiComponent.OpenUIForm(uiFormId.ToString(), userData, uiGroupId.ToString(), pauseCoveredUIForm);
        }
        ...
        public static int? OpenUIForm(this UIComponent uiComponent, string uiFormName, object userData, string uiGroupName,bool pauseCoveredUIForm)
        {

            string url = AssetUtility.GetUIFormAsset(uiFormName);
            if (uiComponent.IsLoadingUIForm(url))
            {
                return null;
            }

            if (uiComponent.HasUIForm(url))
            {
                return null;
            }

            return uiComponent.OpenUIForm(url, uiGroupName, Constant.AssetPriority.UIFormAsset, pauseCoveredUIForm, userData);
        }
        ...
        public static void OpenDialog(this UIComponent uiComponent, DialogParams dialogParams)
        {
            ...
            {
                uiComponent.OpenUIForm(UIFormId.DialogForm, dialogParams,UIGroupId.Pop);
            }
        }
